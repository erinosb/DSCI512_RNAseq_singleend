...
#								directory.
#
#    INPUT: _metadata.txt file: A metadata file with two columns. The first columns
#								is a fastq file names. The second column is blank. The third column is a "nickname"
...
#
# USAGE:
# $ bash RNAseq_analyzer_220624.sh <metadata.txt> <number of threads>
#
# OUTPUT:
#
# KNOWN BUGS:
...
cmd4="featureCounts -T $pthread -a $gtffile -o ${outfeature}counts.txt ${samfilePath[*]}"
echo -e "\t$ $cmd4"
time eval $cmd4
